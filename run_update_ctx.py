...
os.environ["LANGCHAIN_PROJECT"] = f"SynBCIATR Test"
...
def main():
    ...
    output_datafile = "outputs/SynBCIATR/test_part_all_ctx_wot.json"

    # logger setup
    logger.set_log_file("logs/run_update_ctx.log", "a")
